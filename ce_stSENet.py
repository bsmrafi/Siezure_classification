...
class CE_stSENet(nn.Module):
    ...
    def forward(self, x, if_pooling):  
        ...
        return output.squeeze(), cat_f.squeeze(), x1, x2, x3, x4, x5, decov1.squeeze()


if __name__ == "__main__":
    x = Variable(torch.ones([32, 14, 1, 1024]))
    model = CE_stSENet(14, 5, 258)
    output, f, x1, x2, x3, x4, x5, decov1 = model(x, 1)
